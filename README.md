...
**Note:** All files in `data/` are outputs generated by the analysis pipeline in this repo (correlation matrices, centrality metrics, lesion statistics), not the original c-Fos measurements from the source study.
...
```
Davoudian PA, Shao LX, Kwan AC. Shared and Distinct Brain Regions Targeted for Immediate Early Gene Expression by Ketamine and Psilocybin. ACS Chem Neurosci. 2023;14(3):468–480. doi:10.1021/acschemneuro.2c00637
```
